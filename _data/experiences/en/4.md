...
sdate: April 2018
edate: March 2019
company: Konzek Technology
content: >-
  * Developed Industry 4.0 compliant solutions in areas such as Manufacturing
  Execution (MES), Production Efficiency (OEE), Environmental Monitoring, Energy
  Management, System Automation, and Process Control. 
  ...
  * Retmes: 
  ...
  Worked on both server-side (micro architecture, cloud-first, JavaScript, Node.js) and front-end (React, JavaScript, Redux). 
